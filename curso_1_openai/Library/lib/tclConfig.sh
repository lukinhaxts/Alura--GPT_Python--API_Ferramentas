...
# installed.
TCL_PREFIX='C:/Programação/Alura/Formação OpenAI e Python/Projeto---3572/curso_1_openai\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/Programação/Alura/Formação OpenAI e Python/Projeto---3572/curso_1_openai\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/Programação/Alura/Formação OpenAI e Python/Projeto---3572/curso_1_openai\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/Programação/Alura/Formação OpenAI e Python/Projeto---3572/curso_1_openai\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/Programação/Alura/Formação OpenAI e Python/Projeto---3572/curso_1_openai\Library\lib tclstub86.lib'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='C:\ci\tk_1654036608655\work\tcl8.6.12\win\Release_AMD64_VC1916\tclstub86.lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='C:/Programação/Alura/Formação OpenAI e Python/Projeto---3572/curso_1_openai\Library\lib\tclstub86.lib'
